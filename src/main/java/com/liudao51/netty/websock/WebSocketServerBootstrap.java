...
import com.liudao51.netty.hello.HttpServerBootstrap;
...
public class WebSocketServerBootstrap {
    ...
    public WebSocketServerBootstrap(String host, Integer port) {
        this.host = host;
        this.port = port;
    }
    ...
    public void start() {
        ...
        try {
            ...
            serverBootstrap.group(bossGroup, workerGroup) //绑定主线程组与从线程组
                    ...
                    .childHandler(new ChatServerChannelInitializer()); //指定Pipeline的子处理器
